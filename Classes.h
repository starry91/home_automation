...
public:
	Hall (const std::string room_Name, const std::string light, const std::string fan) {};
};

class Kitchen : public Room {
public:
	Kitchen (const std::string room_Name, const std::string light, const std::string fan) {};
};

class Dining : public Room {
public:
	Dining (const std::string room_Name, const std::string light, const std::string fan) {};
};
*/
