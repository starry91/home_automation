...
${OBJECTDIR}/src/Activity.o: src/Activity.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Activity.o src/Activity.cpp
...
${OBJECTDIR}/src/Client.o: src/Client.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Client.o src/Client.cpp

${OBJECTDIR}/src/ClientData.o: src/ClientData.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ClientData.o src/ClientData.cpp
...
${OBJECTDIR}/src/latest_Server.o: src/latest_Server.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/latest_Server.o src/latest_Server.cpp
