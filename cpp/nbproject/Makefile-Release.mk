...
${OBJECTDIR}/autogen_files/proto/AppToCppServer.grpc.pb.o: autogen_files/proto/AppToCppServer.grpc.pb.cc
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/autogen_files/proto/AppToCppServer.grpc.pb.o autogen_files/proto/AppToCppServer.grpc.pb.cc

${OBJECTDIR}/autogen_files/proto/AppToCppServer.pb.o: autogen_files/proto/AppToCppServer.pb.cc
	${MKDIR} -p ${OBJECTDIR}/autogen_files/proto
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/autogen_files/proto/AppToCppServer.pb.o autogen_files/proto/AppToCppServer.pb.cc

${OBJECTDIR}/autogen_files/proto/relay_server.grpc.pb.o: autogen_files/proto/relay_server.grpc.pb.cc
	${MKDIR} -p ${OBJECTDIR}/autogen_files/proto
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/autogen_files/proto/relay_server.grpc.pb.o autogen_files/proto/relay_server.grpc.pb.cc

${OBJECTDIR}/autogen_files/proto/relay_server.pb.o: autogen_files/proto/relay_server.pb.cc
	${MKDIR} -p ${OBJECTDIR}/autogen_files/proto
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/autogen_files/proto/relay_server.pb.o autogen_files/proto/relay_server.pb.cc

${OBJECTDIR}/src/AppToCpp_Server.o: src/AppToCpp_Server.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AppToCpp_Server.o src/AppToCpp_Server.cpp

${OBJECTDIR}/src/Appliances.o: src/Appliances.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Appliances.o src/Appliances.cpp

${OBJECTDIR}/src/Configuration.o: src/Configuration.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Configuration.o src/Configuration.cpp

${OBJECTDIR}/src/CppServerMain.o: src/CppServerMain.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CppServerMain.o src/CppServerMain.cpp

${OBJECTDIR}/src/Data.o: src/Data.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Data.o src/Data.cpp

${OBJECTDIR}/src/ExtFunctions.o: src/ExtFunctions.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ExtFunctions.o src/ExtFunctions.cpp

${OBJECTDIR}/src/RelayServerClient.o: src/RelayServerClient.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RelayServerClient.o src/RelayServerClient.cpp

${OBJECTDIR}/src/Room.o: src/Room.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Room.o src/Room.cpp

${OBJECTDIR}/src/Server.o: src/Server.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Server.o src/Server.cpp
...
${TESTDIR}/TestFiles/f2: ${TESTDIR}/TestFiles/client1.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/TestFiles/client1.o: TestFiles/client1.cpp 
	${MKDIR} -p ${TESTDIR}/TestFiles
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestFiles/client1.o TestFiles/client1.cpp
...
${OBJECTDIR}/autogen_files/proto/AppToCppServer.grpc.pb_nomain.o: ${OBJECTDIR}/autogen_files/proto/AppToCppServer.grpc.pb.o autogen_files/proto/AppToCppServer.grpc.pb.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/autogen_files/proto/AppToCppServer.grpc.pb_nomain.o autogen_files/proto/AppToCppServer.grpc.pb.cc;\
	else  \
...
${OBJECTDIR}/autogen_files/proto/AppToCppServer.pb_nomain.o: ${OBJECTDIR}/autogen_files/proto/AppToCppServer.pb.o autogen_files/proto/AppToCppServer.pb.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/autogen_files/proto/AppToCppServer.pb_nomain.o autogen_files/proto/AppToCppServer.pb.cc;\
	else  \
...
${OBJECTDIR}/autogen_files/proto/relay_server.grpc.pb_nomain.o: ${OBJECTDIR}/autogen_files/proto/relay_server.grpc.pb.o autogen_files/proto/relay_server.grpc.pb.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/autogen_files/proto/relay_server.grpc.pb_nomain.o autogen_files/proto/relay_server.grpc.pb.cc;\
	else  \
...
${OBJECTDIR}/autogen_files/proto/relay_server.pb_nomain.o: ${OBJECTDIR}/autogen_files/proto/relay_server.pb.o autogen_files/proto/relay_server.pb.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/autogen_files/proto/relay_server.pb_nomain.o autogen_files/proto/relay_server.pb.cc;\
	else  \
...
${OBJECTDIR}/src/AppToCpp_Server_nomain.o: ${OBJECTDIR}/src/AppToCpp_Server.o src/AppToCpp_Server.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AppToCpp_Server_nomain.o src/AppToCpp_Server.cpp;\
	else  \
...
${OBJECTDIR}/src/Appliances_nomain.o: ${OBJECTDIR}/src/Appliances.o src/Appliances.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Appliances_nomain.o src/Appliances.cpp;\
	else  \
...
${OBJECTDIR}/src/Configuration_nomain.o: ${OBJECTDIR}/src/Configuration.o src/Configuration.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Configuration_nomain.o src/Configuration.cpp;\
	else  \
...
${OBJECTDIR}/src/CppServerMain_nomain.o: ${OBJECTDIR}/src/CppServerMain.o src/CppServerMain.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CppServerMain_nomain.o src/CppServerMain.cpp;\
	else  \
...
${OBJECTDIR}/src/Data_nomain.o: ${OBJECTDIR}/src/Data.o src/Data.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Data_nomain.o src/Data.cpp;\
	else  \
...
${OBJECTDIR}/src/ExtFunctions_nomain.o: ${OBJECTDIR}/src/ExtFunctions.o src/ExtFunctions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ExtFunctions_nomain.o src/ExtFunctions.cpp;\
	else  \
...
${OBJECTDIR}/src/RelayServerClient_nomain.o: ${OBJECTDIR}/src/RelayServerClient.o src/RelayServerClient.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RelayServerClient_nomain.o src/RelayServerClient.cpp;\
	else  \
...
${OBJECTDIR}/src/Room_nomain.o: ${OBJECTDIR}/src/Room.o src/Room.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Room_nomain.o src/Room.cpp;\
	else  \
...
${OBJECTDIR}/src/Server_nomain.o: ${OBJECTDIR}/src/Server.o src/Server.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O3 -s -Iautogen_files -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Server_nomain.o src/Server.cpp;\
	else  \
