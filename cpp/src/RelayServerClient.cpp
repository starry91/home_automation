...
int RelayServerClient::get_state(const std::string& room_name,
		const std::string& appliance_type, const std::string& appliance_name) {
...
int RelayServerClient::set_state(const std::string& room_name,
		const std::string& appliance_type, const std::string& appliance_name,
		int state) {
	// Data we are sending to the server.
	py_server::Details request;
